...
stmt:
    assignment_stmt             { printf("Reconhecido: Atribuição\n"); }
    ...
    | return_stmt               { printf("Reconhecido: Comando return\n"); }
    | break_stmt                { printf("Reconhecido: Comando break\n"); }
    | continue_stmt             { printf("Reconhecido: Comando continue\n"); }
